    ...
    >
      <form>
		...
		<h1 className="text-xl font-bold flex justify-center min-w-[250px]">
  			<span className="text-[#DEDEDE]">{displayedText} <span className="text-[#00BC5F]">{EndDisplayText}</span></span>
  <		span className="text-[#00BC5F] animate-pulse">|</span>
		</h1>
          </div>
        <div className="flex flex-col gap-6">
		<SignInSocial className="w-full bg-[#00BC5F] hover:bg-[#058E4A] transition-colors duration-300" provider='github'>Clique para fazer login</SignInSocial>
        </div>
